...
import in.co.rays.ORSproject3.dto.DropdownList;
...
public class HTMLUtility {
	...
	public static String getList(String name, String selectedVal, HashMap<String, String> map) {
        ...
        StringBuffer sb = new StringBuffer ("<select style='width: 154px;  height: 36px;' class='form-control' name='" + name + "'>");
        ...
        if (select) {
            ...
            sb.append("<option style='width: 154px;  height: 30px;' selected value=''>-----------Select----------------</option>");
        }
	...
	public static String getList1(String name, String selectedVal, List list) {
        ...
        StringBuffer sb = new StringBuffer("<select style='width: 174px;  height: 36px;' class='form-control' name='" + name + "'>");

        boolean select=true;
        if (select)
        {

            sb.append("<option style='width: 174x;  height: 30px;' selected value=''>----------Select-----------</option>");
        }
