...
import in.co.rays.ORSproject3.model.CollegeModelJDBCImpl;
...
public class CollegeModelTest {
    ...
    public static void testAdd() {
        ...
        try {
            ...
            //dto.setId(1L);
            dto.setName("Acro");
            dto.setAddress("Dewas road");
            dto.setState("mp");
            dto.setCity("indore");
            dto.setPhoneNo("0731233244");
    ...
    public static void testUpdate() {
        ...
        try {
           ...
           dto.setId(1L);
            dto.setName("SGSITS");
            dto.setAddress("High Court");
            dto.setState("UP");
            dto.setCity("Ujjain");
            dto.setPhoneNo("0731234589");
